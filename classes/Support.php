...
class Support
{
     ...
     */
    public function createJiraTicketViaPortal($redcapProjectId, $summary, $issueTypeId, $description, $portalProjectId = null, $redcapProjectName = null, $raise_on_behalf_of = '', $user_firstname = '', $user_lastname = '')
    {
